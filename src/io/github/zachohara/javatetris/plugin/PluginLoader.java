...
public class PluginLoader {
	...
	public static JavaPlugin loadPlugin() throws ClassNotFoundException, NoSuchMethodException,
	IllegalAccessException, IllegalClassFormatException, CancellationException, Exception {
		...
		return PluginLoader.loadPlugin(selectedFile.toURI().toURL());
	}

	/**
	 * @param url
	 * @return
	 * @throws ClassNotFoundException if there is no Robot class defined in the default
	 * package of the imported jar
	 * @throws NoSuchMethodException if there is no default constructor for the Robot class
	 * @throws IllegalAccessException if the default constructor for Robot is not visible
	 * @throws IllegalClassFormatException if the found Robot class does not subclass
	 * JavaPlugin
	 * @throws Exception if an error is caused by the back-end, and is not necessarily the
	 * result of the plugin being incorrect
	 */
	private static JavaPlugin loadPlugin(URL url) throws ClassNotFoundException, NoSuchMethodException,
	IllegalAccessException, IllegalClassFormatException, Exception {
		URL[] urlArray = {url};
